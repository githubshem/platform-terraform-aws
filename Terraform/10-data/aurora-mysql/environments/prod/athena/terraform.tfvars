cluster_identifier = "athena-cluster-prod"
instance_names     = ["athena-cluster-instance", "athena-prod-reader"]
...
secret_name                         = "prod/rds/athena-rds-db-pwd" # Your AWS Secrets Manager Secret Name
