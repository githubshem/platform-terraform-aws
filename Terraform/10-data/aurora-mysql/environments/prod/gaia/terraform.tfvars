# 1. Identity & Sourcing
cluster_identifier = "gaia-prod-cluster"
instance_names     = ["gaia-prod-instance", "gaia-prod-reader"]
...
secret_name                         = "prod/rds/gaia-rds-db-pwd" # Your AWS Secrets Manager Secret Name
