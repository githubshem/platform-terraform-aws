# 1. Identity & Sourcing
cluster_identifier = "horae-prod-cluster"
instance_names     = ["horae-prod-instance", "horae-prod-reader"]
...
secret_name                         = "prod/rds/horae-rds-db-pwd" # Your AWS Secrets Manager Secret Name
