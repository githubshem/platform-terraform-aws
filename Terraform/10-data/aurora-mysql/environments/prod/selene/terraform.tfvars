# 1. Identity & Sourcing
cluster_identifier = "selene-prod-cluster"
instance_names     = ["selene-prod-dbinstance", "selene-prod-reader"]
...
secret_name                         = "prod/rds/selene-rds-db-pwd" # Your AWS Secrets Manager Secret Name
