# 1. Identity & Sourcing
cluster_identifier = "plat-test-gaia-cluster"
instance_names     = ["plat-test-gaia-instance", "plat-test-gaia-reader"]
...
rds_username                        = "gaia_admin"
secret_name                         = "test/rds/gaia-rds-db-pwd" # Your AWS Secrets Manager Secret Name
