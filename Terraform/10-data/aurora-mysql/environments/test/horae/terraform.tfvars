# 1. Identity & Sourcing
cluster_identifier = "plat-test-horae-cluster"
instance_names     = ["plat-test-horae-instance", "plat-test-horae-reader"]
...
rds_username                        = "sztnb_admin"
secret_name                         = "test/rds/horae-rds-db-pwd" # Your AWS Secrets Manager Secret Name
