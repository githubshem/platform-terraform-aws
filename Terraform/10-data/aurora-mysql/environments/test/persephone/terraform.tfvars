# 1. Identity & Sourcing
cluster_identifier = "plat-test-persephone-cluster"
instance_names     = ["plat-test-persephone-instance", "plat-test-persephone-reader"]
...
secret_name                         = "test/rds/persephone-rds-db-pwd" # Your AWS Secrets Manager Secret Name
