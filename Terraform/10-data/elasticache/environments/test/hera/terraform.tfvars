# =====================================================
# plat-test-hera-redis Redis (ElastiCache replication group)
# =====================================================

aws_region = "ap-southeast-1"

# 1. Identity
replication_group_id = "plat-test-hera-redis"
description          = "Test Redis cluster plat-test-hera-redis"
...
final_snapshot_identifier = "plat-test-hera-redis-final"

apply_immediately = true

tags = {
  Name        = "plat-test-hera-redis"
  Environment = "test"
  ManagedBy   = "terraform"
}