# =====================================================
# plat-test-persephone-redis Redis (ElastiCache replication group)
# =====================================================

aws_region = "ap-southeast-1"

# 1. Identity
replication_group_id = "plat-test-persephone-redis"
description          = "Test Redis cluster plat-test-persephone-redis"
...
final_snapshot_identifier = "plat-test-persephone-redis-final"

apply_immediately = true

tags = {
  Name        = "plat-test-persephone-redis"
  Environment = "test"
  ManagedBy   = "terraform"
}