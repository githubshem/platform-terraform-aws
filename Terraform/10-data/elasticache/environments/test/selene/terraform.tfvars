# =====================================================
# plat-test-selene-redis Redis (ElastiCache replication group)
# =====================================================

aws_region = "ap-southeast-1"

# 1. Identity
replication_group_id = "plat-test-selene-redis"
description          = "Test Redis cluster plat-test-selene-redis"
...
parameter_group_name = "plat-test-defaultredis7"

# 6. Networking
# Shared subnet group for selene/persephone/gaia. This env OWNS (creates) it.
...
final_snapshot_identifier = "plat-test-selene-redis-final"

apply_immediately = true

tags = {
  Name        = "plat-test-selene-redis"
  Environment = "test"
  ManagedBy   = "terraform"
}