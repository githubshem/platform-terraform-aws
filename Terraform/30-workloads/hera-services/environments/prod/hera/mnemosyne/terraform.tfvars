...
microservices = {
  "microservice-metadata" = {
    ...
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-microservice-metadata:latest"
    host_volume_name = ""
    host_volume_path = ""
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/metadata-tg-prod/bd0b02e8363dea47"]
  ...
  "microservice-metrics" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-microservice-metrics:latest"
    host_volume_name = "awseb-logs-microservice-metrics-prod"
    host_volume_path = "/var/log/containers/microservice-metrics-prod"
    target_group_arn = []
  ...
  "microservice-transaction" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-microservice-transaction:latest"
    host_volume_name = "awseb-logs-microservice-transaction-prod"
    host_volume_path = "/var/log/containers/microservice-transaction-prod"
    target_group_arn = []
  ...
  "microservice-edge" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-microservice-edge:latest"
    host_volume_name = "awseb-logs-microservice-edge-prod"
    host_volume_path = "/var/log/containers/microservice-edge-prod"
    target_group_arn = []
