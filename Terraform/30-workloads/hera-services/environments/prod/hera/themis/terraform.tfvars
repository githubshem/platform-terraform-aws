...
microservices = {
  "config-server" = {
    ...
    count              = 0
    port               = 8902
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/framework-config-server:plat-prod-20260223132753"
    host_volume_name   = "awseb-logs-framework-config-server"
    host_volume_path   = "/var/log/containers/framework-config-server"
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/config-server-public-tg/272c9d38bdf0df6c", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/config-tg-prod/0539de0b98130832"]
  ...
  "eureka-server" = {
    ...
    count              = 0
    port               = 8901
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-eureka-server:plat-prod-20260223111303"
    host_volume_name   = "awseb-logs-framework-eureka-server"
    host_volume_path   = "/var/log/containers/framework-eureka-server"
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/eureka-tg-prod/c538960d8c115d87", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-prod-public-eureka-tg/b5cc0e8db03367ce"]
  ...
  "gateway-server" = {
    ...
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-tg-prod/afacde5fefa8e4ce", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-prod-gateway-server-public/85e4ef2884ac674b"]
  ...
  "framework-compress-server" = {
    ...
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/compress-server-tg-prod/8304910f4eebcb13"]
