...
microservices = {
  "platform-adminapi" = {
    ...
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-platform-adminapi:latest"
    host_volume_name = "awseb-logs-platform-adminapi-test"
    host_volume_path = "/var/log/containers/platform-adminapi-test"
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/platform-adminapi-tg-test/86efe7e362d79433"]
  ...
  "platform-coreapi" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-platform-coreapi:latest"
    host_volume_name = "awseb-logs-platform-coreapi-test"
    host_volume_path = "/var/log/containers/platform-coreapi-test"
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/platform-coreapi-tg-test/f3f7ebad4782943d"]
  ...
  "platform-openapi" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-platform-openapi:latest"
    host_volume_name = "awseb-logs-platform-openapi-test"
    host_volume_path = "/var/log/containers/platform-openapi-test"
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/platform-openapi-tg-test/e2b3df1df1f0cb22"]
