...
microservices = {
  "microservice-metadata" = {
    ...
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-metadata:latest"
    host_volume_name = ""
    host_volume_path = ""
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/metadata-tg-test/4d5f1444dd60c270"]
    ...
    env_vars = {
      "SPRING_APPLICATION_NAME"                   = "metadata-restapi"
  ...
  "microservice-metrics" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-metrics:latest"
    host_volume_name = "awseb-logs-microservice-metrics-test"
    host_volume_path = "/var/log/containers/microservice-metrics-test"
    target_group_arn = []
    ...
    env_vars = {
      "SPRING_APPLICATION_NAME"                   = "statistics-restapi"
      "SPRING_PROFILES_ACTIVE"                    = "plat-test"
      "SERVER_PORT"                               = "8307"
      "EUREKA_INSTANCE_INSTANCE_ID"               = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"         = "true"
  ...
  "microservice-transaction" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-transaction:latest"
    host_volume_name = "awseb-logs-microservice-transaction-test"
    host_volume_path = "/var/log/containers/microservice-transaction-test"
    target_group_arn = []
    ...
    env_vars = {
      "SPRING_APPLICATION_NAME"                   = "transaction-restapi"
      "SPRING_PROFILES_ACTIVE"                    = "plat-test"
      "SERVER_PORT"                               = "8306"
      "EUREKA_INSTANCE_INSTANCE_ID"               = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"         = "true"
  ...
  "microservice-edge" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-edge:latest"
    host_volume_name = "awseb-logs-microservice-edge-test"
    host_volume_path = "/var/log/containers/microservice-edge-test"
    target_group_arn = []
    ...
    env_vars = {
      "SPRING_APPLICATION_NAME"                   = "expressway-restapi"
      "SPRING_PROFILES_ACTIVE"                    = "plat-test"
      "SERVER_PORT"                               = "8103"
      "EUREKA_INSTANCE_INSTANCE_ID"               = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"         = "true"
