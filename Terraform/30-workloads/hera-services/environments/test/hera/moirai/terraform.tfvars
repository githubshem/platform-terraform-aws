...
microservices = {
  "microservice-scheduler" = {
    ...
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-scheduler:latest"
    host_volume_name = ""
    host_volume_path = ""
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/scheduler-tg-test/ba1dd3f8194ab4e6"]
