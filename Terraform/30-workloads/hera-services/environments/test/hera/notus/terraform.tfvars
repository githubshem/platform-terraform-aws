...
microservices = {
  "microservice-notus" = {
    ...
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-microservice-notus:latest"
    host_volume_name = "awseb-logs-microservice-notus-test"
    host_volume_path = "/var/log/containers/microservice-notus-test"
    target_group_arn = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-micro-notus-tg-pub/dc7628ff19a2ec3b", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-microsvc-notus-tg/a6c88f1c0223356b"]
  ...
  "boreas-notus" = {
    ...
    # Standardized Image and Volume Paths
    image            = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-boreas-notus:latest"
    host_volume_name = "awseb-logs-boreas-notus-test"
    host_volume_path = "/var/log/containers/boreas-notus-test"
    target_group_arn = []
