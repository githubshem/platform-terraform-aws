...
microservices = {
  "apollo-config" = {
    ...
    count              = 0
    port               = 9100
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-apollo-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "apollo-filter" = {
    ...
    count              = 0
    port               = 9101
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-apollo-filter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
  ...
  "gateway-apollo" = {
    ...
    count              = 0
    port               = 9102
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-apollo:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-apollo-tg-prod/c9659ced638df965"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "openapi-apollo" = {
    ...
    count              = 0
    port               = 9103
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-apollo:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-apollo-tg-prod/1f7cce0347c7a518"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
