...
microservices = {
  "gateway-arachne" = {
    ...
    count              = 0
    port               = 9180
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-arachne:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-arachne-tg-prod/bef15242395105be"]
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "gateway-arachne"
  ...
  "openapi-arachne" = {
    ...
    count              = 0
    port               = 9181
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-arachne:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-arachne-tg-prod/90fb3a2a4c1b1308"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "openapi-arachne"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9181"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
  ...
  "arachne-certificate" = {
    ...
    count              = 0
    port               = 9182
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-arachne-certificate:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "arachne-certificate"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9182"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
