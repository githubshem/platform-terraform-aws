...
microservices = {
  "demeter-monitor" = {
    ...
    count              = 0
    port               = 9128
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-demeter-monitor:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 8
  ...
  "gateway-demeter" = {
    ...
    count              = 0
    port               = 9129
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-demeter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-demeter-tg-prod/1351bb3774199202"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "openapi-demeter" = {
    ...
    count              = 0
    port               = 9130
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-demeter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-demeter-tg-prod/fa3a57c14cd262fd"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "notus-demeter" = {
    ...
    count              = 0
    port               = 9131
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-notus-demeter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
