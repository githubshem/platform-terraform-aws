...
microservices = {
  "gateway-hades" = {
    ...
    count              = 0
    port               = 9132
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-hades:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-hades-tg-prod/2038f2eaea288196"]
    max_capacity       = 4
  ...
  "hades-config" = {
    ...
    count              = 0
    port               = 9133
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hades-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "hades-filter" = {
    ...
    count              = 0
    port               = 9134
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hades-filter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
  ...
  "hades-record" = {
    ...
    count              = 0
    port               = 9135
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hades-record:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 8
  ...
  "hades-metadata" = {
    ...
    count              = 0
    port               = 9136
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hades-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "openapi-hades" = {
    ...
    count              = 0
    port               = 9137
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-hades:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-hades-tg-prod/05e44cbe17fe1a33"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
