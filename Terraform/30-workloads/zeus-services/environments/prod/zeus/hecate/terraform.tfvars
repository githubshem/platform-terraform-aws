...
microservices = {
  "openapi-filter" = {
    ...
    count              = 0
    port               = 9199
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-filter:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-filter-public-tg-upg/5bffb0693981cbd6", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-filter-tg-prod/bd84a0622a9c2290"]
    max_capacity       = 6
