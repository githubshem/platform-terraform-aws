...
microservices = {
  "hermes-config" = {
    ...
    count              = 0
    port               = 9095
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hermes-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
  ...
  "hermes-metadata" = {
    ...
    count              = 0
    port               = 9096
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hermes-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
  ...
  "hermes-transaction" = {
    ...
    count              = 0
    port               = 9097
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hermes-transaction:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "gateway-hermes" = {
    ...
    count              = 0
    port               = 9098
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-hermes:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-hermes-tg-prod/699d574c7404560f"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "openapi-hermes" = {
    ...
    count              = 0
    port               = 9099
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-hermes:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-hermes-tg-prod/354a759ffcf3ec2d"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
