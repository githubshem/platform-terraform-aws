...
microservices = {
  "hestia-algorithm" = {
    ...
    count              = 0
    port               = 9123
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hestia-algorithm:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "hestia-config" = {
    ...
    count              = 0
    port               = 9124
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hestia-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "hestia-scoring" = {
    ...
    count              = 0
    port               = 9125
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-hestia-scoring:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
  ...
  "gateway-hestia" = {
    ...
    count              = 0
    port               = 9126
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-hestia:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-hestia-tg-prod/8110cac5351f3540"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "openapi-hestia" = {
    ...
    count              = 0
    port               = 9127
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-hestia:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-hestia-tg-prod/a3f83bb728917ef0", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-hestia-prod-public/0a922ea65f9baa67"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
