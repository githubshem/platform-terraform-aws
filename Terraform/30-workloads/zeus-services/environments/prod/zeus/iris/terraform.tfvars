...
microservices = {
  "callback-iris" = {
    ...
    count              = 0
    port               = 9150
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-callback-iris:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "gateway-iris" = {
    ...
    count              = 0
    port               = 9160
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-iris:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-iris-tg-prod/0b7c33d0df8475be"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "openapi-iris" = {
    ...
    count              = 0
    port               = 9161
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-iris:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-iris-tg-prod/83d36a4a75d20e81"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "iris-config" = {
    ...
    count              = 0
    port               = 9162
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-iris-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "iris-email" = {
    ...
    count              = 0
    port               = 9163
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-iris-email:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 13
  ...
  "iris-metadata" = {
    ...
    count              = 0
    port               = 9164
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-iris-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "iris-template" = {
    ...
    count              = 0
    port               = 9165
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-iris-template:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "iris-workflow" = {
    ...
    count              = 0
    port               = 9166
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-iris-workflow:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
