...
microservices = {
  "gateway-kronos" = {
    ...
    count              = 0
    port               = 9183
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-kronos:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-kronos-tg-prod/e1f25ef9bccfadac"]
    max_capacity       = 4
  ...
  "openapi-kronos" = {
    ...
    count              = 0
    port               = 9184
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-kronos:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-kronos-tg-prod/2e9f77405b867757"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "kronos-config" = {
    ...
    count              = 0
    port               = 9185
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-config:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "kronos-doc-template" = {
    ...
    count              = 0
    port               = 9186
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-doc-template:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "kronos-metadata" = {
    ...
    count              = 0
    port               = 9187
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "kronos-note-template" = {
    ...
    count              = 0
    port               = 9188
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-note-template:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "kronos-script-template" = {
    ...
    count              = 0
    port               = 9189
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-script-template:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "kronos-website" = {
    ...
    count              = 0
    port               = 9190
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-kronos-website:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "notus-kronos" = {
    ...
    count              = 0
    port               = 9191
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-notus-kronos:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
