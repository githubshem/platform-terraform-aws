...
microservices = {
  "gateway-morpheus" = {
    ...
    count              = 0
    port               = 9192
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-morpheus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-morpheus-tg-prod/8a39999a98af3962"]
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "gateway-morpheus"
  ...
  "morpheus-ledger" = {
    ...
    count              = 0
    port               = 9193
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-morpheus-ledger:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "morpheus-ledger"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9193"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
  ...
  "morpheus-metadata" = {
    ...
    count              = 0
    port               = 9194
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-morpheus-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "morpheus-metadata"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9194"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
