...
microservices = {
  "gateway-nereus" = {
    ...
    count              = 0
    port               = 9176
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-nereus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-nereus-tg-prod/07d81e978de07591"]
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "gateway-nereus"
