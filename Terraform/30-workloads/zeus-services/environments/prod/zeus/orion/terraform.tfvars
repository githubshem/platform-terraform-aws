...
microservices = {
  "gateway-orion" = {
    ...
    count              = 0
    port               = 9195
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-gateway-orion:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-orion-tg-prod/260f33a1d9936184"]
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "gateway-orion"
  ...
  "openapi-orion" = {
    ...
    count              = 0
    port               = 9196
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-orion:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-orion-tg-prod/19df6f9c757d4fb1"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "openapi-orion"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9196"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
  ...
  "orion-dwm" = {
    ...
    count              = 0
    port               = 9197
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-orion-dwm:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "orion-dwm"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9197"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
  ...
  "orion-report" = {
    ...
    count              = 0
    port               = 9198
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-orion-report:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
    ...
    cp_weight          = 100
    env_vars = {
      "SPRING_APPLICATION_NAME"                               = "orion-report"
      "SPRING_PROFILES_ACTIVE"                                = "plat-prod"
      "SERVER_PORT"                                           = "9198"
      "EUREKA_INSTANCE_INSTANCE_ID"                           = "$${spring.cloud.client.ip-address}:$${server.port}"
      "EUREKA_INSTANCE_PREFER_IP_ADDRESS"                     = "true"
