...
microservices = {
  "openapi-rhea" = {
    ...
    count              = 0
    port               = 9203
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-openapi-rhea:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-rhea-tg-prod/a80623a0dcb2a3e5"]
    max_capacity       = 6
  ...
  "rhea-audit" = {
    ...
    count              = 0
    port               = 9204
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-rhea-audit:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "rhea-data-collection" = {
    ...
    count              = 0
    port               = 9205
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-rhea-data-collection:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "rhea-warehouse" = {
    ...
    count              = 0
    port               = 9206
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-prod-rhea-warehouse:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 6
