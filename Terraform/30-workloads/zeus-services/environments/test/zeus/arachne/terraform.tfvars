...
microservices = {
  "gateway-arachne" = {
    ...
    count              = 0
    port               = 9180
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-arachne:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "openapi-arachne" = {
    ...
    count              = 0
    port               = 9181
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-openapi-arachne:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-openapi-arachne-pub/698c0ff80bf4db23"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "arachne-certificate" = {
    ...
    count              = 0
    port               = 9182
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-arachne-certificate:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
