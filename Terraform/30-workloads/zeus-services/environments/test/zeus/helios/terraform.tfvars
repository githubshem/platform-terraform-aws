...
microservices = {
  "gateway-helios" = {
    ...
    count              = 0
    port               = 9142
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-helios:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-helios-tg-test/61001e4e8d22e5cf"]
    max_capacity       = 4
  ...
  "helios-data-lookup" = {
    ...
    count              = 0
    port               = 9143
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-helios-data-lookup:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "helios-employee" = {
    ...
    count              = 0
    port               = 9144
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-helios-employee:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "helios-oauth" = {
    ...
    count              = 0
    port               = 9145
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-helios-oauth:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "helios-tenant" = {
    ...
    count              = 0
    port               = 9146
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-helios-tenant:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "helios-project" = {
    ...
    count              = 0
    port               = 9147
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-helios-project:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "openapi-helios" = {
    ...
    count              = 0
    port               = 9148
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-openapi-helios:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-helios-tg-test/a3e069cbf52984db", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-helios-test-tg/86514ad8f5aabc7d", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-openapi-helios-tg-pub/630bef25794be481"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "notus-helios" = {
    ...
    count              = 0
    port               = 9149
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-notus-helios:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
