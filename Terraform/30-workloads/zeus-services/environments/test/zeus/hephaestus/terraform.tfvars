...
microservices = {
  "gateway-hephaestus" = {
    ...
    count              = 0
    port               = 9138
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-hephaestus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-hephaestus-tg-test/69bad16a57988a9a"]
    max_capacity       = 4
  ...
  "hephaestus-netdisk" = {
    ...
    count              = 0
    port               = 9139
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-hephaestus-netdisk:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "hephaestus-storage" = {
    ...
    count              = 0
    port               = 9140
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-hephaestus-storage:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "openapi-hephaestus" = {
    ...
    count              = 0
    port               = 9141
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-openapi-hephaestus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-hephaestus-tg-test/84b00cb2d50f1c34", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-openapi-kangaro-pb/b314e83d196b896f"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
