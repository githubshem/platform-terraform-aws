...
microservices = {
  "gateway-morpheus" = {
    ...
    count              = 0
    port               = 9192
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-morpheus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "morpheus-ledger" = {
    ...
    count              = 0
    port               = 9193
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-morpheus-ledger:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "morpheus-metadata" = {
    ...
    count              = 0
    port               = 9194
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-morpheus-metadata:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
