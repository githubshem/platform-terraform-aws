...
microservices = {
  "gateway-orion" = {
    ...
    count              = 0
    port               = 9195
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-orion:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/gateway-orion-tg-test/b821c943ee821a92"]
    max_capacity       = 4
  ...
  "openapi-orion" = {
    ...
    count              = 0
    port               = 9196
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-openapi-orion:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/openapi-orion-tg-test/dc93c27af6e6167a", "arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-openapi-orion-pub/4fc1735b826ee27f"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "orion-dwm" = {
    ...
    count              = 0
    port               = 9197
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-orion-dwm:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "orion-report" = {
    ...
    count              = 0
    port               = 9198
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-orion-report:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
