...
microservices = {
  "gateway-proteus" = {
    ...
    count              = 0
    port               = 9177
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-gateway-proteus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
  ...
  "openapi-proteus" = {
    ...
    count              = 0
    port               = 9178
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-openapi-proteus:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = ["arn:aws:elasticloadbalancing:ap-southeast-1:123456789012:targetgroup/plat-test-openapi-proteus-pb/0afca038baaeea59"]
    max_capacity       = 4
    cpu_target_value   = 75.0
    scale_out_cooldown = 180
    scale_in_cooldown  = 180
  ...
  "proteus-ticket" = {
    ...
    count              = 0
    port               = 9179
    image              = "123456789012.dkr.ecr.ap-southeast-1.amazonaws.com/plat-test-proteus-ticket:latest"
    host_volume_name   = ""
    host_volume_path   = ""
    target_group_arn   = []
    max_capacity       = 4
